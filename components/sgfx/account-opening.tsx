...
const steps = [
  {
    ...
    image: "/images/register-phone.png",
  ...
  return (
    <section className="bg-[#EEEEEE] py-8 md:py-12 px-4 md:px-8 lg:px-12">
      <div className="container mx-auto max-w-4xl">
        <h2 className="text-[#001523] text-lg md:text-2xl font-bold text-center mb-8">
          ...
          {steps.map((step, index) => (
            <div key={index} className="rounded-xl overflow-hidden border border-gray-100 shadow-sm flex flex-col">
              ...
              <div className="bg-white px-4 pb-5 pt-4 flex flex-col items-center text-center flex-1">
                ...
                <p className="text-[#6b7280] text-[11px] mb-4 leading-relaxed max-w-[220px] flex-1">
                  {step.description}
                </p>
                <button className="bg-[#13AA7A] hover:bg-[#1259c0] text-white font-semibold px-2 py-1 rounded-2xl text-[14px] transition-colors">
                  {step.cta}
                </button>
              </div>
            </div>
