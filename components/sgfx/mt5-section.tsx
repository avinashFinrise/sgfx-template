...
export function MT5Section() {
      ...
      <div className="container mx-auto max-w-3xl">
        <div className="flex flex-col md:flex-row justify-between gap-2 md:gap-6">
          ...
          <div className="py-4 md:py-12 lg:pt-12 text-center md:text-left">
            <h2 className="text-[#001523] text-2xl md:text-2xl lg:text-[32px] font-bold mb-4 leading-tight text-center px-8 md:px-0 md:text-left">
  ...
  <Image
    ...
    width={200}
    height={380}
    className="relative w-68 md:w-64 lg:w-108 h-auto object-contain"
  />
</div>
